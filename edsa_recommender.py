...
def main():
    ...
    if page_selection == "new movie release":
        ...
        st.markdown('[(resources/imgs/download.png)](https://www.netflix.com/za/)', unsafe_allow_html=True)
        st.image('[(resources/imgs/download.png)](https://www.netflix.com/za/)',width = 600)
