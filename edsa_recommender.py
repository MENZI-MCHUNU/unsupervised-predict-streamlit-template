...
def main():
    ...
    if page_selection  =="Search for a Movie":
        ...
        if title == "Animation":     
            ...
            st.video('https://www.youtube.com/watch?v=HJwvbmRXym4')
            st.markdown("Average Rating:")  
            st.subheader("Pocahontas (1995)")
            st.video('https://www.youtube.com/watch?v=hpVNsegX94g')
            st.markdown("Average Rating:")  
            st.subheader("Goofy Movie, A (1995)")
            st.video('https://www.youtube.com/watch?v=aFYCQoIpGuE')
            st.markdown("Average Rating:") 
            st.subheader("Gumby: The Movie (1995)")
            st.video('https://www.youtube.com/watch?v=gOWa8t0zSz8')
            st.markdown("Average Rating:")                                                                  
        #'## By year'
