...
def main():
    ...
    if page_selection == "new movie release":
        ...
        st.markdown('[(resources/imgs/download.png)](https://www.netflix.com/za/)')
        st.markdown('<img src="resources/imgs/download.png">(https://www.netflix.com/za/)', unsafe_allow_html=True)
        st.markdown('<p>For more information about building data Apps Please go to :<a href="https://www.netflix.com/za/"><img src="resources/imgs/download.png"></a></p>', unsafe_allow_html=True)	
